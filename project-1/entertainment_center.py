...
matrix = media.Movie("The Matrix",
                     "An elusive figure considered to be the most dangerous man\
                      alive, can answer his question -- What is the Matrix?",
...
robin_hood = media.Movie("Robin Hood: Prince of Thieves",
                         ...
                         and the tyranny of the Sheriff of Nottingham, he \
                         decides to fight back as an outlaw.",
...
logan = media.Movie("Logan",
                    ...
                    Professor X in a hide out on the Mexican border. ",
...
madmax = media.Movie("Mad Max: Fury Road",
                     "Haunted by his turbulent past, Mad Max (Tom Hardy) \
...
martian = media.Movie("The Martian",
                      ...
                      is presumed dead after a fierce storm and left behind by\
                      his crew.",
